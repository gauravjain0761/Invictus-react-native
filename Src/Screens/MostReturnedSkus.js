...
export default function MostReturnedSkus() {
  ...
  const totalSalesCount = allDetails?.most_customer_returned_skus[
    indexDate
  ].reduce(
  ...
  const totalReturnCount = allDetails?.most_customer_returned_skus[
    indexDate
  ].reduce(
    (previousScore, currentScore, index) =>
  ...
  const totalCustomerReturnCount = allDetails?.most_customer_returned_skus[
    indexDate
  ].reduce(
    (previousScore, currentScore, index) =>
  ...
  const newData = [
    {
      sku: "FO_BC_Oppo-A52-lightgreen_SMOK_1PK",
      total_sales: 1,
      return_count: 1,
      customer_return_percentage: 100.0,
    },
    {
      sku: "GOR_TG2019_VIVO-Y20G_11D_1PK",
      total_sales: 1,
      return_count: 1,
      customer_return_percentage: 100.0,
    },
    {
      sku: "GF_TGMOTO G40 2PK,",
      total_sales: 1,
      return_count: 1,
      customer_return_percentage: 100.0,
    },
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <ScrollView horizontal>
          <View style={ApplicationStyles.chartCardWithourPadding}>
            ...
            <FlatList
              bounces={false}
              data={allDetails?.most_customer_returned_skus[indexDate]}
              ...
              ListFooterComponent={() => {
                if (
                  allDetails?.most_customer_returned_skus[indexDate].length ===
                  0
                ) {
                  return (
